...
""" + index_style + """
    ...
    <body>
        ...
        Sale, <b>version 8.0 or later</b>. You can start an <a href='https://www.priyabeatus.com/start'>online free trial</a>,
        or <a href='https://www.priyabeatus.com/page/download'>download and install</a> it yourself.
        </p>
        <p>
        For more information on how to setup the Point of Sale with
        the PosBox, please refer to
        <a href='https://www.priyabeatus.com/documentation/user/point_of_sale/posbox/index.html'>the manual</a>.
        </p>
        <p>
        ...
        <p>For any other question, please contact the Odoo support at <a href='http://www.priyabeatus.com/help'>www.priyabeatus.com/help</a>
        </p>
    </body>
</html>
