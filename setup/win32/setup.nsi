...
!define MUI_FINISHPAGE_LINK_LOCATION "https://www.priyabeatus.com/page/contactus"
...
;    WriteRegDWORD HKLM     "${UNINSTALL_REGISTRY_KEY}" "VersionMinor" "${REVISION_VERSION}"
    ...
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "URLInfoAbout" "https://www.priyabeatus.com"
